<?php
    ...
    function registrasi($data){
        ...
        if(mysqli_fetch_assoc($result)){ //jika username yang ditambahkan sudah ada
            echo "<script>
        ...
        if($password !== $password2){
            ...
            return false; //untuk menghentikan function
        }

        // enkripsi password
        $password = password_hash($password, PASSWORD_DEFAULT); //ini membutuhkan 2 parameter yaitu mana yang akan dienkripsi, dan algoritma enkripsi yang digunakan
